...
RSpec.feature 'Admin Users Page', js: true do
  ...
  context 'with loginned admin user' do
    ...
    scenario 'show' do
      ...
      expect(all('.user_list__tbl__head__row th:nth-child(4)')[0]).to have_content '管理者'
      ...
      expect(all('.user_list__tbl__body__row td:nth-child(4)')[0]).to have_text '✔︎'
      ...
      expect(all('.user_list__tbl__body__row td:nth-child(4)')[1]).not_to have_text '✔︎'
      ...
      expect(all('.user_list__tbl__body__row td:nth-child(4)')[2]).not_to have_text '✔︎'
